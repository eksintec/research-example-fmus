...
Here some FMU implementations are stored that represent different test cases for the publication in the AutoSimCConfig group.
Each folder represents a differnt variant of a model with different skills.
