# AutoSimConfig Test FMU with manual reset
...
In order to provide a test case for evaluating, the model was merely renamed and represents the initial system behavior.
